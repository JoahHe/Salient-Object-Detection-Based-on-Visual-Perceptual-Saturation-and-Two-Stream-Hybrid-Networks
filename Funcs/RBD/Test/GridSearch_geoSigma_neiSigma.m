...
dataset = 'SED2';
SRC = fullfile('.\', dataset);                %Path of input images
BDCON = '.\Data\BDCON';   %Path for saving bdCon feature image
SP = fullfile('.\SPs', dataset);                      %Path for saving superpixel's index image and mean color image
RES = fullfile('.\GridSearch', dataset);                   %Path for saving different saliency maps
